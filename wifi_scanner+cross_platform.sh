...
display_help() {
    ...
    echo -e "  -i, --interface     Specify the wireless interface (Linux only)"
...
main() {
    ...
    while [[ "$#" -gt 0 ]]; do
        case $1 in
            ...
            -i|--interface) user_interface="$2"; shift ;;
            *) echo -e "${MAGENTA}${BOLD}❌ Unknown option: $1${NC}"; display_help; exit 1 ;;
        esac
        shift
    done
